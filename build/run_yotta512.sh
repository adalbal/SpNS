...
#SBATCH --job-name=yotta512                     # Job name
...
#SBATCH --output=yotta512/log_%j.out            # Standard output log
#SBATCH --error=yotta512/log_%j.err             # Standard error log
...
cat params_yotta512nu
srun ./a.out params_yotta512nu

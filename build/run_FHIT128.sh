...
#SBATCH --job-name=FHIT-128                     # Job name
...
#SBATCH --output=FHIT128/log_%j.out             # Standard output log
#SBATCH --error=FHIT128/log_%j.err              # Standard error log
